...
app.include_router(memory_router, prefix="/v1/memory", tags=["memory"], dependencies=[Depends(require_client_key)])
app.include_router(streaming_memory_router, prefix="/v1/streaming-memory", tags=["streaming-memory"], dependencies=[Depends(require_client_key)])
app.include_router(memory_retrieval_router, prefix="/v1/memory-retrieval", tags=["memory-retrieval"], dependencies=[Depends(require_client_key)])
app.include_router(memory_ingestion_router, prefix="/v1/memory-ingestion", tags=["memory-ingestion"], dependencies=[Depends(require_client_key)])
app.include_router(conversation_memory_router, prefix="/v1/conversation-memory", tags=["conversation-memory"], dependencies=[Depends(require_client_key)])

app.include_router(voice_router, prefix="/v1/voice", tags=["voice"], dependencies=[Depends(require_client_key)])
app.include_router(vector_memory_router, prefix="/v1/vector-memory", tags=["vector-memory"], dependencies=[Depends(require_client_key)])
app.include_router(persona_router, prefix="/v1/persona", tags=["persona"], dependencies=[Depends(require_client_key)])
app.include_router(system_router, prefix="/v1/system", tags=["system"])
app.include_router(emotional_reasoning_router, prefix="/v1/emotional-reasoning", tags=["emotional-reasoning"], dependencies=[Depends(require_client_key)])

app.include_router(avatar_training_router, prefix="/v1/avatar-training", tags=["avatar-training"], dependencies=[Depends(require_client_key)])
...
app.include_router(avatar_generation_job_router, prefix="/v1/avatar-generation-job", tags=["avatar-generation-job"], dependencies=[Depends(require_client_key)])
app.include_router(avatar_renderer_handoff_router, prefix="/v1/avatar-renderer-handoff", tags=["avatar-renderer-handoff"], dependencies=[Depends(require_client_key)])
app.include_router(avatar_stub_renderer_router, prefix="/v1/avatar-preview-renderer", tags=["avatar-preview-renderer"], dependencies=[Depends(require_client_key)])
app.include_router(avatar_stub_renderer_router, prefix="/v1/avatar-stub-renderer", tags=["avatar-stub-renderer-legacy"], dependencies=[Depends(require_client_key)])
